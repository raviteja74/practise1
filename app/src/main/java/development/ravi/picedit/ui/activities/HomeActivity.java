...
import development.ravi.picedit.presentation.presenters.activity.HomeActivityPresenter;
import development.ravi.picedit.presentation.views.activity.HomeView;
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialog)
                ...
                .setPositiveButton(getString(R.string.go_to_app_settings), (dialogInterface, i) -> {
                    Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS,
                            Uri.parse("package:" + "development.ravi.picedit"));
