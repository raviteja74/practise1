package development.ravi.picedit.adapters;
...
public class ImageAlbumsAdapter extends RecyclerView.Adapter<ImageAlbumsAdapter.ViewHolder> {
    ...
    private OnAlbumClickListener1 mOnAlbumClickListener;

    public void setOnAlbumClickListener(OnAlbumClickListener1 onAlbumClickListener) {
        mOnAlbumClickListener = onAlbumClickListener;
    }

    public interface OnAlbumClickListener1 {
